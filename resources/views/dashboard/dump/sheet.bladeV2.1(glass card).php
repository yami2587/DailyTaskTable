                                ...
                                <div class="task-row" id="task-{{ $a->id }}">
                                    <div style="flex:1;">
                                        ...
                                        <div class="small"><strong>Task:</strong>
                                            {{-- {{ $a->leader_remark ?? '-' }} --}}
                                            <span class="remark-limit" onclick="viewFullRemark(`{{ addslashes($a->leader_remark ?? '-') }}`)">
                                                {{ \Illuminate\Support\Str::limit($a->leader_remark, 60) }}
                                                <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="#6366F1" style="margin-left:4px;">
                                        ...
                                        <div class="small"><strong>Status:</strong>
                                            {{ ucfirst($a->status ?? 'not_completed') }}
                                        </div>

                                        @if ($a->is_submitted && $a->member_remark)
                                        <div class="static-submitted mt-2">Member remark:
                                            {{-- {{ $a->member_remark }} --}}
                                            <span class="remark-limit" onclick="viewFullRemark(`{{ addslashes($a->member_remark ?? '-') }}`)">
                                                {{ \Illuminate\Support\Str::limit($a->member_remark, 60) }}
                                                <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="#6366F1" style="margin-left:4px;">
                                                    <path d="M1.5 5l5 5 5-5H1.5z" />
                                                </svg>
                                            </span>
                                        ...
                                        <form id="edit-form-{{ $a->id }}"
                                            ...
                                            <div class="row gx-2">
                                                ...
                                                <div class="col-7">
                                                    ...
                                                    <textarea name="leader_remark" class="input" rows="2">
                                                    {{-- {{ $a->leader_remark }} --}}
                                                    <span class="remark-limit" onclick="viewFullRemark(`{{ addslashes($a->leader_remark ?? '-') }}`)">
                                                        {{ \Illuminate\Support\Str::limit($a->leader_remark, 60) }}
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="#6366F1" style="margin-left:4px;">
                                            ...
                                            <textarea name="member_remark" id="leader-reply-{{ $a->id }}" class="input" rows="2">
                                            {{-- {{ $a->member_remark ?? '' }} --}}
                                            <span class="remark-limit" onclick="viewFullRemark(`{{ addslashes($a->member_remark ?? '-') }}`)">
                                                {{ \Illuminate\Support\Str::limit($a->member_remark, 60) }}
                                                <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="#6366F1" style="margin-left:4px;">
                    ...
                    <div class="card-surface">
                        ...
                        <div class="mb-3">
                            <div class="small"><strong>Team:</strong>
                                {{ $sheet->team->team_name ?? 'Team ' . $sheet->team_id }}
                            </div>
                        ...
                        <div class="card-surface mb-3" style="padding:10px;">
                            ...
                            <div class="member-list mt-2">
                                ...
                                <div class="member-row">
                                    {{-- <div class="avatar {{ $tm->is_leader ? 'leader' : 'member' }}">{{ $initials }}
                                </div> --}}
...
<script>
    function viewFullRemark(text) {
        document.getElementById('remarkModalBody').innerText = text;
