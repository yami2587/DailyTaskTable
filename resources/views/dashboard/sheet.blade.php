...
@section('content')
    ...
    <style>
        ...
        .task-status.not_completed {
            background: linear-gradient(135deg, #EF4444, #C92A2A);
            color: #fff;
        }
        ...
        .remark-limit.show-chevron svg {
            transform: translateY(0);
            opacity: 1;
        }

        /* modal body */
        .modal-content.remark-modal {
            border-radius: 12px;
        }
        ...
        /*  */
        /* FIX: Make assignment card fully responsive */
        .task-row {
            display: flex;
            justify-content: space-between;
            align-items: flex-start;
    ...
    <div class="page-wrap">
        ...
        <div class="gradient-shell mt-3"
            style="border-radius:16px;padding:2px;background:linear-gradient(135deg,#6366F1,#EC4899,#10B981);">
                    ...
                    <div class="left">
                        <div class="card-surface">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                ...
                                @if ($sheet)
                                    <div class="small">Team: <span class="badge-role"
                                            style="background:linear-gradient(45deg,#6366F1,#3B82F6);color:white;padding:4px 8px;border-radius:999px;font-weight:600;font-size:12px;">#{{ $sheet->team_id }}</span>
                                    </div>
                                @endif
                            </div>
                            @if (!$sheet)
                                            ...
                                            <div class="d-flex justify-content-between align-items-start">
                                                <div>
                                                    ...
                                                    <div class="small">
                                                        {{-- ID: {{ $memberId }} --}}
                                                        @if ($m->is_leader)
                                                            <span><!-- leader icon --><svg xmlns="http://www.w3.org/2000/svg" width="13"
                                                ...
                                                <div class="d-flex flex-column align-items-end">
                                                    @if (optional($sheet->sheet_date)->isToday() && !$isFinalized)
                                                        <button class="btn btn-ghost btn-sm" type="button"
                                                            onclick="toggleCreateTask('{{ $memberId }}')">
                                            ...
                                            <div style="margin-top:10px;">
                                                @forelse($memberAssignments as $a)
                                                    <div class="task-row" id="task-{{ $a->id }}">
                                                        {{-- <div style="flex:1;"> --}}<div class="left-col">
                                                                ...
                                                                <div class="small"><strong>Task:</strong>
                                                                    ...
                                                                    <span class="remark-limit" data-full="{{ addslashes($leader_plain) }}"
                                                                        data-plain="{{ $leader_plain }}">
                                                                    ...
                                                                    <div class="static-submitted mt-2">
                                                                        ...
                                                                        <div>
                                                                            <span class="remark-limit"
                                                                                data-full="{{ addslashes($member_plain) }}"
                                                                                data-plain="{{ $member_plain }}">
                                                                ...
                                                                <div class="right-col">
                                                                    ...
                                                                    @if(optional($sheet->sheet_date)->isToday() && !$isFinalized)
                                                                        <div class="mb-1">
                                                                            <button class="btn btn-outline-primary btn-sm"
                                                                                onclick="openEditAssignment({{ $a->id }})">
                                                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                                                    fill="currentColor" viewBox="0 0 16 16">
                                                                                    <path fill-rule="evenodd"
                                                                                        d="M11.096.644a2 2 0 0 1 2.791.036l1.433 1.433a2 2 0 0 1 .035 2.791l-.413.435-8.07 8.995a.5.5 0 0 1-.372.166h-3a.5.5 0 0 1-.234-.058l-.412.412A.5.5 0 0 1 2.5 15h-2a.5.5 0 0 1-.354-.854l1.412-1.412A.5.5 0 0 1 1.5 12.5v-3a.5.5 0 0 1 .166-.372l8.995-8.07zm-.115 1.47L2.727 9.52l3.753 3.753 7.406-8.254z" />
                                                                                </svg>
                                                                            </button>
                                                                        </div>
                                                                    ...
                                                                    @else
                                                                        <div class="badge-role"
                                                                            style="background:#eef2ff;color:#0b3aa3;padding:6px 10px;border-radius:999px;font-weight:600;">
                                                                            Locked</div>
                                                                    @endif
                                                                </div>
    ...
    <select name="client_id[]" class="input client-select selectpicker form-control" data-live-search="true">
        ...
        @endforeach
                                                                    ...
                                                                    <td style="text-align:center;">
                                                                        <button type="button" class="btn btn-primary btn-sm"
                                                                            onclick="addNewTaskRow('{{ $memberId }}')">
                                    ...
                                    @endforeach
                                            ...
                                            {{-- ➕➕➕➕➕➕➕➕➕➕➕unfreez buttion➕➕➕➕➕➕➕➕➕➕➕ --}}
                                            <div class="mt-2"><button class="btn btn-ghost btn-sm"
                                                    onclick="unfreezeSheet({{ $sheet->id }})">Unfreeze Sheet (Testing)</button>
                                            </div>
                                @else
                                            {{-- MEMBER view --}}
                                            <div class="member-card">
                                                    ...
                                                    <div class="task-row" id="task-{{ $a->id }}">
                                                        {{-- <div style="flex:1;"> --}}<div class="left-col">
                                                                ...
                                                                <div class="small"><strong>Remark:</strong>
                                                                    ...
                                                                    <span class="remark-limit"
                                                                        data-full="{{ addslashes(e($a->leader_remark ?? '-')) }}"
                                                                        data-plain="{{ e($a->leader_remark ?? '-') }}">{{ e($leader_short) }}
                                                                        <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13"
                                                                            fill="#6366F1" viewBox="0 0 16 16">
                                                                            <path d="M1.5 5l5 5 5-5H1.5z" />
                                                                        </svg>
                                                                ...
                                                                @if($isFinalized || $a->is_submitted)
                                                                    <div class="static-submitted mt-2">
                                                                        ...
                                                                        <div style="margin-top:6px;"><strong>Your Response:</strong>
                                                                            <span class="remark-limit"
                                                                                data-full="{{ addslashes(e($a->member_remark ?? '-')) }}"
                                                                                data-plain="{{ e($a->member_remark ?? '-') }}">{{ e(\Illuminate\Support\Str::limit($a->member_remark ?? '-', 60)) }}
                                                                                <svg xmlns="http://www.w3.org/2000/svg" width="13"
                                                                                    height="13" fill="#6366F1" viewBox="0 0 16 16">
                                                                                    <path d="M1.5 5l5 5 5-5H1.5z" />
                                                                                </svg>
                                                                            </span>
                                                                        </div>
                                                                ...
                                                                @else
                                                                    <form class="member-submit-form"
                                                                        ...
                                                                        <div class="d-flex gap-3 align-items-center">
                                                                            <label><input type="radio" name="status" value="completed"
                                                                            ...
                                                                            <label><input type="radio" name="status" value="not_completed"
                                                                                ...
                                                                                completed</label>
                                                                            <label><input type="radio" name="status" value="in_progress"
                                                                                    @if(($a->status ?? '') == 'in_progress') checked @endif
                                                                                    onchange="toggleRemarkBox({{ $a->id }}, this)"> In
                                                                                progress</label>
                                                                        </div>
                                                                        ...
                                                                        <div class="mt-2"><button class="btn btn-primary btn-sm"
                                    ...
                                    <div class="card-surface">
                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                            ...
                                            @if($sheet)
                                                <div class="small">Date:
                                                    {{ optional($sheet->sheet_date)->toDateString() ?? $date }}</div>
                                            @endif
                                        </div>
                                        ...
                                        @if($sheet)
                                            ...
                                            <div class="card-surface mb-3" style="padding:10px;">
                                                ...
                                                <div class="member-list mt-2">
                                                    @foreach($members as $tm)
                                                        @php $e = $tm->employee ?? null;
                                                        $name = $e->emp_name ?? $tm->emp_id; @endphp
                                                        <div class="member-row">
                                                            ...
                                                            <div style="margin-left:2px;">@if($tm->is_leader)<svg
                                            ...
                                            <div class="card-surface">
                                                ...
                                                <div class="small text-muted mb-2">Complete By today</div>
                                                ...
                                                @if($isLeader && optional($sheet->sheet_date)->isToday() && !$isFinalized)
                                                    ...
                                                    <div class="d-flex gap-2 mt-2">
                                                        <button class="btn btn-primary btn-sm"
                                                            onclick="saveTarget({{ $sheet->id }})">Save Target</button>
                ...
                <div id="toast" class="toast"
                    style="background:linear-gradient(90deg,#6366F1,#EC4899);box-shadow:0 4px 16px rgba(99,102,241,0.4);color:#fff;padding:10px 14px;border-radius:8px;position:fixed;right:20px;bottom:20px;z-index:9999;opacity:0;transform:translateY(6px);transition:all .18s;">
                </div>
                        ...
                        <div class="modal-content" style="border-radius:12px; ">
                            ...
                            <div class="modal-body">
                                ...
                                <input type="text" id="finalConfirmInput" class="form-control"
                                    placeholder="Type date or name">
                                <small id="finalConfirmError" class="text-danger mt-1 d-block"
                ...
                <div id="taskConfirmCard" style="
                    ...
                    <div style="background:#fff;
                        ...
                        <div style="display:flex; gap:10px; justify-content:flex-end;">
                            <button class="btn btn-primary" onclick="confirmSubmitCardFinal()">Submit</button>
                            <button class="btn btn-light" onclick="closeTaskConfirmCard()">Cancel</button>
                        </div>

                        <input type="hidden" id="taskConfirmAssignId">
                        <input type="hidden" id="taskConfirmFormData">
                    </div>
                </div>
...
function openEditAssignment(id) {
    ...
    //                 function removeThisRow(btn) { const tr = btn.closest('tr'); if (tr) tr.remove(); }
                    ...
                    //     return false;
                    // }
                    // NEW — open the confirmation card popup
                    function submitMemberForm(ev, assignId) {
                        ev.preventDefault();

                        // store assign ID
                        document.getElementById("taskConfirmAssignId").value = assignId;

                        // store form data temporarily
                        document.getElementById("taskConfirmFormData").value =
                            new URLSearchParams(new FormData(ev.currentTarget)).toString();

                        // show popup
                        document.getElementById("taskConfirmCard").style.display = "flex";
                    }


                    // CLOSE popup
                    function closeTaskConfirmCard() {
                        document.getElementById("taskConfirmCard").style.display = "none";
                    }


                    // FINAL SUBMISSION
                    async function confirmSubmitCardFinal() {
                        const assignId = document.getElementById("taskConfirmAssignId").value;
                        const formData = document.getElementById("taskConfirmFormData").value;
