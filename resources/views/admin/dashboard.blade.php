...
@section('content')
    ...
    <style>
        ...
        .fade-soft {
            animation: fadeSoft .28s ease both;
        }
                                ...
                                <div class="card-surface mb-3 fade-soft">
                                    ...
                                    @else
                                        <div class="small mt-2" style="min-height:80px; white-space:pre-wrap;">
                                            {{ $sheet->target_text ?? 'No target set for this day.' }}</div>
                                    @endif
                                </div>
                            @endif
                                            ...
                                            <div class="task-card fade-soft">
                                                <div class="task-left">
                                                    ...
                                                    <div class="meta mt-2">
                                                        ...
                                                        <span
                                                            class="small">{{ \Illuminate\Support\Str::limit($a->member_remark ?? '-', 100) }}</span>
    ...
    {{--
    <script
        src="https://cdn.jsdelivr.net/npm/bootstrap-select@1.14.0-beta3/dist/js/bootstrap-select.bundle.min.js"></script>
    --}}
    <script>
        (function () {
            ...
            //  admin team daily target save (AJAX)
